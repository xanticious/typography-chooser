...
export function PortfolioDemo() {
  const projects = ["Flux Identity System","Meridian Exhibition","Solstice Campaign","Arc Product Film"];
  return (
    <div className={styles.demo}>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.contactCta}>
          <p className={styles.body}>Available for select projects — <a className={styles.inlineLink} href="#">let's talk</a>.</p>
        </div>
      </main>
    </div>
  );
