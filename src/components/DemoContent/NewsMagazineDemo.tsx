  ...
  return (
    <div className={styles.demo}>
      ...
      <nav className={styles.nav}>
        <a className={styles.navLink} href="#">World</a>
        <a className={styles.navLink} href="#">Politics</a>
        <a className={styles.navLink} href="#">Technology</a>
        <a className={styles.navLink} href="#">Climate</a>
        <a className={styles.navLink} href="#">Culture</a>
      </nav>
      <main className={styles.main}>
        <article className={styles.leadStory}>
          ...
          <p className={styles.body}>Delegates from 140 nations gathered in Geneva on Wednesday to address mounting pressure to accelerate decarbonization commitments ahead of the 2030 deadline.</p>
        </article>
        <div className={styles.secondaryGrid}>
          <article className={styles.secondaryStory}>
            <span className={styles.sectionLabel}>TECH</span>
            <h3 className={styles.subheading}>AI Chip Wars Intensify as New Players Enter Market</h3>
          </article>
          <article className={styles.secondaryStory}>
