      ...
      <main className={styles.main}>
        <article className={styles.article}>
          ...
          <p className={styles.body}>
            Over 1 billion people worldwide live with some form of disability. Accessible design
          ...
          <ul>
            ...
            <li className={styles.body}>
              Understandable — language is clear, errors are explained
            </li>
        ...
        <form className={styles.a11yForm} aria-label="Contact form demo">
          <label className={styles.formLabel} htmlFor="a11y-name">
            Full Name <span aria-hidden="true">*</span>
          </label>
          <input className={styles.formInput} id="a11y-name" type="text" autoComplete="name" />
          <label className={styles.formLabel} htmlFor="a11y-email">
        ...
        <p className={styles.body}>
          <a className={styles.focusDemo} href="#">
            Focus ring example
          </a>{" "}
          — tab to see high-visibility outline.
        </p>
      </main>
    </div>
  );
