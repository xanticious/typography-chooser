      ...
      <main className={styles.main}>
        <div className={styles.minimalistMain}>
          ...
          <p className={styles.body}>
            I've been thinking about the gap between starting and shipping. Not the fear of failure
            — most people know about that — but the quieter problem: the project that is 95% done
            and lives in a folder called <code>final-v3</code>.
          </p>
          <blockquote className={styles.pullQuote}>"Done is a choice, not a state."</blockquote>
          <p className={styles.body}>
            The last 5% is rarely technical. It's editorial. Deciding what to cut, what to keep, and
            — hardest of all — when it's enough.
          </p>
          <p className={styles.body}>
