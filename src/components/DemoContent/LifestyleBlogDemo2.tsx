      ...
      <main className={styles.main}>
        <article className={styles.article}>
          ...
          <p className={styles.body}>
            The expired Kodak Gold 200 had been sitting in my fridge for two years. I didn't plan to
            burn a roll on a Tuesday night — but Shinjuku at 3am, rain-slicked and nearly empty,
            demanded it.
          </p>
          ...
          <p className={styles.body}>I shot 36 frames. Four are keepers. That's a good night.</p>
        </article>
